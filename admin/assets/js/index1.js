$(function (e) {
    ...
    // CHARTJS SALES CHART OPEN (Total Orders)
    if (document.getElementById('saleschart')) {
        var ctx = document.getElementById('saleschart').getContext('2d');
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: (typeof ordersLabels !== 'undefined') ? ordersLabels : ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
                datasets: [{
                    barPercentage: 0.1,
                    barThickness: 6,
                    barGap: 0,
                    ...
                    minBarLength: 2,
                    label: 'Total Orders',
                    data: (typeof ordersData !== 'undefined') ? ordersData : [19, 10, 15, 8, 6, 10, 13],
            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: { enabled: true } // Enabled tooltip for dynamic data
                },
                responsive: true,
                scales: {
                    x: {
    ...
    // CHARTJS LEADS CHART  OPEN (Total Sales)
    if (document.getElementById('leadschart')) {
        var ctx1 = document.getElementById('leadschart').getContext('2d');
        new Chart(ctx1, {
            type: 'line',
            data: {
                labels: (typeof salesLabels !== 'undefined') ? salesLabels : ['Date 1', 'Date 2'],
                datasets: [{
                    label: 'Total Sales',
                    data: (typeof salesData !== 'undefined') ? salesData : [45, 23, 32],
    ...
    // PROFIT CHART OPEN (Pending Cancellations)
    if (document.getElementById('profitchart')) {
        var ctx2 = document.getElementById('profitchart').getContext('2d');
        new Chart(ctx2, {
            type: 'bar',
            data: {
                labels: (typeof cancelLabels !== 'undefined') ? cancelLabels : ['Mon', 'Tue'],
                datasets: [{
                    barPercentage: 0.1,
                    barThickness: 6,
                    maxBarThickness: 8,
                    ...
                    data: (typeof cancelData !== 'undefined') ? cancelData : [10, 12, 5],
    ...
    // COST CHART OPEN (Unread Messages)
    if (document.getElementById('costchart')) {
        var ctx3 = document.getElementById('costchart').getContext('2d');
        new Chart(ctx3, {
            type: 'line',
            data: {
                labels: (typeof msgsLabels !== 'undefined') ? msgsLabels : ['Date 1', 'Date 2'],
                datasets: [{
                    label: 'Unread Messages',
                    data: (typeof msgsData !== 'undefined') ? msgsData : [28, 56],
                    backgroundColor: 'transparent',
                    borderColor: '#f7ba48',
                    borderWidth: '2.5',
                    pointBorderColor: 'transparent',
    ...
    // SALES CHART 2 (Online Orders)
    if (document.getElementById('saleschart2')) {
        var ctx4 = document.getElementById('saleschart2').getContext('2d');
        new Chart(ctx4, {
            type: 'bar',
            data: {
                labels: (typeof ordersLabels !== 'undefined') ? ordersLabels : ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
                datasets: [{
                    ...
                    minBarLength: 2,
                    label: 'Online Orders',
                    data: (typeof onlineData !== 'undefined') ? onlineData : [0,0,0,0,0,0,0],
                    backgroundColor: '#11d2c2', // Info colorish
                    borderColor: '#11d2c2',
                    borderRadius: 10,
                    borderWidth: 1
                }]
    ...
    // SALES CHART 3 (COD Orders)
    if (document.getElementById('saleschart3')) {
        var ctx5 = document.getElementById('saleschart3').getContext('2d');
        new Chart(ctx5, {
            type: 'bar',
            data: {
                labels: (typeof ordersLabels !== 'undefined') ? ordersLabels : ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
                datasets: [{
                    ...
                    minBarLength: 2,
                    label: 'COD Orders',
                    data: (typeof codData !== 'undefined') ? codData : [0,0,0,0,0,0,0],
                    backgroundColor: '#4ecc48', // Success color
                    borderColor: '#4ecc48',
                    borderRadius: 10,
                    borderWidth: 1
                }]
